...
- The code and tests are committed locally on
  `codex/trueforge-content-agent`; the publication commit is not a deployment.
...
```text
https://github.com/myz1912/hackathon/blob/codex/trueforge-content-agent/demo/daoharness-trueforge-demo.mp4
```
